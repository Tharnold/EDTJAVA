...
public class Graphe1  {
    ...
    public static void main(String[] args){
     try{
         String query = "select IDsite,capacité from salle";
         JDBCCategoryDataset dataset= new JDBCCategoryDataset(connexion.connecterDB(), query);
         JFreeChart chart = ChartFactory.createLineChart("notre graphe","ID du site","capacité du site", dataset, PlotOrientation.VERTICAL, false, true, true);
