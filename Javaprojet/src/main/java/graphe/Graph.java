...
public class Graph  {
    ...
    public static void main(String[] args){
     try{
         String query = "select nom,capacité from salle";
         JDBCCategoryDataset dataset= new JDBCCategoryDataset(connexion.connecterDB(), query);
         JFreeChart chart = ChartFactory.createLineChart("notre graphe","nom de la salle","capacité de la salle", dataset, PlotOrientation.VERTICAL, false, true, true);
