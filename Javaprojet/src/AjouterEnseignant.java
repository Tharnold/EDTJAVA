...
public class AjouterEnseignant extends Frame implements ActionListener{
   ...
   JFrame modifUtilisateur1=new JFrame();
	...
	JTextField IDe =new JTextField(20);
	 JLabel num=new JLabel("Cours qu'il/elle enseigne : ");
   ...
   ;
	...
	JLabel Titre=new JLabel("Ajouter un l'utilisateur");
...
public AjouterEnseignant()
	{          JPanel p11=new JPanel(new GridLayout(1,2));
		...
		p9.add(num);p9.add(wnum);
               ...
               panelText1.add(p11); panelText1.add(p9);
...
public void actionPerformed(ActionEvent e) {
		...
		{int numero1=(new Integer(wnum.getText()));
			...
			Statement stm=cnx.createStatement ();
                        stm.executeUpdate("insert into enseignant(IDutilisateur,IDcours)values("+IDs+","+numero1+")");
