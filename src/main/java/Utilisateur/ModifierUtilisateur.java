...
public class ModifierUtilisateur extends Frame implements ActionListener{
	...
	JTextField wNom =new JTextField(20);
        JLabel Prénom=new JLabel("rentrez le nouveau Prénom :");
	JTextField wPrénom =new JTextField(20);
	...
	public ModifierUtilisateur()
	{
		...
		modifUtilisateur.add(valider);panelButton.add(annuler);
		...
		wNom.addActionListener(this);
                ...
                wPrénom.addActionListener(this);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{	
                                int IDs,Nom1,Prénom1,Mail1,Mdp1,Droits1;
				
				IDs=(new Integer(wID.getText()));
				
				Nom1=(new Integer(wNom.getText()));
                                Prénom1=(new Integer(wPrénom.getText()));
                                Mail1=(new Integer(wMail.getText()));
                                Mdp1=(new Integer(wMdp.getText()));
			...
			Statement stm=cnx.createStatement ();
					...
					stm.executeUpdate("update utilisateur set Nom = "+Nom1+""); 
                                        stm.executeUpdate("update utilisateur set Prénom = "+Prénom1+"");
                                        stm.executeUpdate("update utilisateur set Mail = "+Mail1+"");
                                        stm.executeUpdate("update utilisateur set Mdp = "+Mdp1+"");
                                        stm.executeUpdate("update utilisateur set Droits = "+Droits1+"");
